...
class ActivityServiceImplTest {
    ...
    void joinActivity_success_shouldAddParticipantAndPublishEvent() {
        ...
        // Assert
        verify(activityMapper).joinParticipant(activity.getId(), user.getId(), false, false);
    ...
    void joinActivity_activityNotFound_shouldThrow() {
        ...
        verify(activityMapper, never()).joinParticipant(anyLong(), anyLong(), anyBoolean(), anyBoolean());
    ...
    void joinActivity_activityFull_shouldAddToWaiting() {
        ...
        verify(activityMapper).joinParticipant(activity.getId(), user.getId(), true, false);
    ...
    void joinActivity_femalePriority_femaleJoins_quotaAvailable_shouldSucceed() {
        ...
        // Assert
        verify(activityMapper).joinParticipant(activity.getId(), femaleUser.getId(), false, false);
        verify(eventPublisher).publishEvent(any(ActivityEvent.class));
    }
    ...
    void joinActivity_femalePriority_maleJoins_femaleQuotaAvailable_shouldAddToWaiting() {
        ...
        verify(activityMapper).joinParticipant(activity.getId(), user.getId(), true, false); // isWaiting = true
    ...
    void joinActivity_femalePriority_maleJoins_femaleQuotaFull_shouldJoinNormally() {
        ...
        verify(activityMapper).joinParticipant(activity.getId(), user.getId(), false, false); // isWaiting = false
        verify(eventPublisher).publishEvent(any(ActivityEvent.class));
    }
